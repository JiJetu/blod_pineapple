...
const Dashboard = () => {
  ...
  // Static dummy data — fully hardcoded
  const totalStudents = 1200;
  const totalAwards = 120;
  const availableCertificates = 3200;
  ...
  const factionWiseAwards = [
    { name: "Bilbies", value: 1025, color: "#4CAF50" },
    { name: "Bandicoots", value: 1025, color: "#2196F3" },
    { name: "Wallabies", value: 1025, color: "#FFC107" },
    { name: "Numbats", value: 1025, color: "#F44336" },
  ];
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
        <div className="bg-white rounded-lg shadow-md p-6 flex items-center justify-between border border-primary">
          <div>
            ...
            <h2 className="text-4xl font-bold text-primary mt-3 roboto">
              {totalStudents}
            </h2>
          </div>
